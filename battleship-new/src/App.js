...
const enemyAttack = () => {
  ...
  setSquareA1(attack.includes(sendShips === "A1") ? "hit" : attack.includes(sendShip1 === "A1") ? "hit" : attack.includes(sendShip2 === "A1") ? "hit" : attack.includes(sendShip3 === "A1") ? "hit" : attack.includes(sendShip4 === "A1") ? "hit" : attack.includes("A1") ? "miss" : "" )
}
const attacked = () => {
